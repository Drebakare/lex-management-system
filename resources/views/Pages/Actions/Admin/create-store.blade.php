                                ...
                                <div class="row">
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            ...
                                            <input id="productname" name="store " type="text" class="form-control" required>
                                        </div>
                                    </div>
                                </div>
        ...
        <div class="modal-dialog modal-sm">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <form method="post" action="{{route('user.edit-store-details', ['token' => $store->token])}}">
                        @csrf
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="form-group">
                                    <label for="productname">Store Name</label>
                                    <input id="productname" value="{{$store->store}}" name="store" type="text" class="form-control" required>
                                </div>
                            </div>
                        </div>
